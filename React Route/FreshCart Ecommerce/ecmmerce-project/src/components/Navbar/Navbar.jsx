  ...
  <nav className="fixed-top navbar navbar-expand-lg bg-body-tertiary">
    <div className="container-fluid">
      ...
      <ul className="navbar-nav">
        <li className="nav-item"><Link className="navbar-brand" to="/">Navbar</Link></li>
      ...
      <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
        <ul className="navbar-nav ms-auto">
          ...
          {userData === null ? 
          <>
          <li className="nav-item"><Link className="nav-link" to="RegisterYup">RegisterYup</Link></li>
          <li className="nav-item"><Link className="nav-link" to="Register">Register</Link></li>
          <li className="nav-item"><Link className="nav-link" to="Login">Login</Link></li>
          </>
              
          : 
          <li className="nav-item"><a className="nav-link" role="button" onClick={handleLogout} style={{cursor:'pointer'}}>Logout</a></li>
          }
